...
public class FqlCheckerSelectClauseImpl extends ASTWrapperPsiElement implements FqlCheckerSelectClause {

  public FqlCheckerSelectClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
