...
public class FqlCheckerTableExpressionImpl extends ASTWrapperPsiElement implements FqlCheckerTableExpression {

  public FqlCheckerTableExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FqlCheckerTableExpression2> getTableExpression2List() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FqlCheckerTableExpression2.class);
  }
