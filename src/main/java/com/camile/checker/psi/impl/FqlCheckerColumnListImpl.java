...
public class FqlCheckerColumnListImpl extends ASTWrapperPsiElement implements FqlCheckerColumnList {

  public FqlCheckerColumnListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FqlCheckerVisitor visitor) {
    visitor.visitColumnList(this);
  }
