...
public class FqlCheckerDerivedColumnImpl extends ASTWrapperPsiElement implements FqlCheckerDerivedColumn {

  public FqlCheckerDerivedColumnImpl(@NotNull ASTNode node) {
    super(node);
  }
