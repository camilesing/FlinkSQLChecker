...
public class FqlCheckerQueryPrimaryImpl extends ASTWrapperPsiElement implements FqlCheckerQueryPrimary {

  public FqlCheckerQueryPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }
