...
public class FqlCheckerExpressionImpl extends ASTWrapperPsiElement implements FqlCheckerExpression {

  public FqlCheckerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
