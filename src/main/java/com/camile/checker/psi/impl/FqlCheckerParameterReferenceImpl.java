...
public class FqlCheckerParameterReferenceImpl extends ASTWrapperPsiElement implements FqlCheckerParameterReference {

  public FqlCheckerParameterReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
