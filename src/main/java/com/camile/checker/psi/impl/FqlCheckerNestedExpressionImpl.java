...
public class FqlCheckerNestedExpressionImpl extends ASTWrapperPsiElement implements FqlCheckerNestedExpression {

  public FqlCheckerNestedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FqlCheckerVisitor visitor) {
    visitor.visitNestedExpression(this);
  }
