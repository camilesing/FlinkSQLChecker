...
public class FqlCheckerSourceTableImpl extends ASTWrapperPsiElement implements FqlCheckerSourceTable {

  public FqlCheckerSourceTableImpl(@NotNull ASTNode node) {
    super(node);
  }
