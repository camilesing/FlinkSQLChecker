...
public class FqlCheckerSelectStatementImpl extends ASTWrapperPsiElement implements FqlCheckerSelectStatement {

  public FqlCheckerSelectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
