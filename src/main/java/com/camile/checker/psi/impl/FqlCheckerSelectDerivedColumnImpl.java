...
public class FqlCheckerSelectDerivedColumnImpl extends ASTWrapperPsiElement implements FqlCheckerSelectDerivedColumn {

  public FqlCheckerSelectDerivedColumnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FqlCheckerVisitor visitor) {
    visitor.visitSelectDerivedColumn(this);
  }
