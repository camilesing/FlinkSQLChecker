...
public class FqlCheckerCommonValueExpressionImpl extends ASTWrapperPsiElement implements FqlCheckerCommonValueExpression {

  public FqlCheckerCommonValueExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
