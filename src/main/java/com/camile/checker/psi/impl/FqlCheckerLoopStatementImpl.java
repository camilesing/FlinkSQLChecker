...
public class FqlCheckerLoopStatementImpl extends ASTWrapperPsiElement implements FqlCheckerLoopStatement {

  public FqlCheckerLoopStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FqlCheckerStatement getStatement() {
    return findNotNullChildByClass(FqlCheckerStatement.class);
  }
