...
public class FqlCheckerOrderedAggregateFunctionImpl extends ASTWrapperPsiElement implements FqlCheckerOrderedAggregateFunction {

  public FqlCheckerOrderedAggregateFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FqlCheckerVisitor visitor) {
    visitor.visitOrderedAggregateFunction(this);
  }
