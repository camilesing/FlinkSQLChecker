...
public class FqlCheckerWindowSpecificationImpl extends ASTWrapperPsiElement implements FqlCheckerWindowSpecification {

  public FqlCheckerWindowSpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FqlCheckerVisitor visitor) {
    visitor.visitWindowSpecification(this);
  }
