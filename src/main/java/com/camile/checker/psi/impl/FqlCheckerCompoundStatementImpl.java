...
public class FqlCheckerCompoundStatementImpl extends ASTWrapperPsiElement implements FqlCheckerCompoundStatement {

  public FqlCheckerCompoundStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
