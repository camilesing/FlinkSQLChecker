...
public class FqlCheckerWhileStatementImpl extends ASTWrapperPsiElement implements FqlCheckerWhileStatement {

  public FqlCheckerWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
