...
public class FqlCheckerTableConstraintImpl extends ASTWrapperPsiElement implements FqlCheckerTableConstraint {

  public FqlCheckerTableConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }
