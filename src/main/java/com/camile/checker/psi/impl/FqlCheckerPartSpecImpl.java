...
public class FqlCheckerPartSpecImpl extends ASTWrapperPsiElement implements FqlCheckerPartSpec {

  public FqlCheckerPartSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FqlCheckerVisitor visitor) {
    visitor.visitPartSpec(this);
  }
